...
" 		16 July, 2014 - Tony Camuso
" 		Changed to ctrl-F5 to comment and ctrl-F6 to uncomment, was
" 		ctrl-c and ctrl-x, respectively.
...
noremap  <silent> <C-F5> :call CommentLine()<CR>
" key-mappings for range comment lines in visual <Shift-V> mode
vnoremap <silent> <C-F5> :call RangeCommentLine()<CR>

" key-mappings for un-comment line in normal mode
noremap  <silent> <C-F6> :call UnCommentLine()<CR>
" key-mappings for range un-comment lines in visual <Shift-V> mode
vnoremap <silent> <C-F6> :call RangeUnCommentLine()<CR>
