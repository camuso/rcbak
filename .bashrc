...
alias rsyncv='rsync -Pvat -e "ssh -o 'StrictHostKeyChecking=no' -o 'UserKnownHostsFile=/dev/null'"'
alias rsyncp='rsync -Pat -e "ssh -o 'StrictHostKeyChecking=no' -o 'UserKnownHostsFile=/dev/null'"'
